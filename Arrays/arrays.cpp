...
Ошибка на этапе выполнения Run-Time Check Failure #2 возникает при выходе за пределы статического массива на запись. 
То есть, когда мы пытаемся записать значение не в сам массив, а рядом с ним.
